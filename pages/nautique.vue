...
<script>
// a la place de hikings -> nautique
import nautiques from '../static/nautique.js'
...
function createMap() {
  ...
  var nautiqueIcon = L.icon({
    iconUrl: require('~/assets/images/nautique.png'),
    iconSize: [35, 35],
    iconAnchor: [0, 0],
    popupAnchor: [0, 0],
    shadowSize: [0, 0],
  ...
  nautiques.forEach(function(nautique) {
    const mapMarker = L.marker(
      [
        nautique['coordinates']['latitude'],
